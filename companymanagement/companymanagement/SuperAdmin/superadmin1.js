...
function tablecell(index, name, email, phone, owner, street, city, state, country, duns, type) {
    ...
    editcell.innerHTML = '<input type="submit" id="editbtn" class="btn " data-toggle="modal" data-target="#editProductModal" onclick="onEdit(' + index + ')" value="Edit">';
    deletecell.innerHTML = '<input type="submit" id="deletebtn" class="btn btn-danger"   onclick="onDelete(' + index + ')" value="Delete">';
